...
<div class="container ">
    <div class="row">
       ...
       <div class="mb-3">
           <div class="card">
               <div class="card-body">
                   <h3 class="text-success">Edit Details</h3>
                   <div class="mb-3">
                <form action="{{route('store')}}" method="post">
                   ...
                   <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="maths" value="{{$result->maths}}" class="form-control">
                        @error("maths")
                       <p class="text-danger small fw-bold">{{$message}}</p>
                       @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="">sci</label>
                        <input type="text" name="sci" value="{{$result->sci}}" class="form-control">
                        @error("sci")
                       <p class="text-danger small fw-bold">{{$message}}</p>
                       @enderror
                    </div>
                    <div class="mb-3">
                        <label for="">sst</label>
                        <input type="text" name="sst" value="{{$result->sst}}" class="form-control">
                        @error("sst")
                       <p class="text-danger small fw-bold">{{$message}}</p>
                       @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" name="hindi" value="{{$result->hindi}}" class="form-control">
                        @error("hindi")
                       <p class="text-danger small fw-bold">{{$message}}</p>
                       @enderror
                    </div>
                    <div class="mb-3">
                        <label for="">eng</label>
                        <input type="text" name="eng" value="{{$result->eng}}" class="form-control">
                        @error("eng")
                       <p class="text-danger small fw-bold">{{$message}}</p>
                       @enderror
                    </div>
